...
- Ruby object model for scenes, groups, transforms, cameras, lights, geometries, common materials including matcap and shadow materials, textures, and common math primitives.
