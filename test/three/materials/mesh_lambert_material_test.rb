...
class ThreeMeshLambertMaterialTest < Minitest::Test
  ...
  def test_accepts_parameters
    material = Three::MeshLambertMaterial.new(color: 0x00ff00, wireframe: true, flat_shading: true, opacity: 0.25, transparent: true)
  ...
  def test_to_h
    material = Three::MeshLambertMaterial.new(color: 0x112233, flat_shading: true)
