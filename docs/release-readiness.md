...
- Ruby object model for scenes, groups, transforms, cameras, lights, geometries, common materials including matcap materials, textures, and common math primitives.
