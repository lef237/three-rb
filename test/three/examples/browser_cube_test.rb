...
class ThreeBrowserCubeExampleTest < Minitest::Test
  ...
  def test_ruby_example_exercises_gemstone_and_text_title
    ...
    assert_includes ruby, "helvetiker_regular.typeface.json"
  ...
  def test_package_script_runs_browser_smoke_test
    ...
    assert_equal "2.9.4-2026-07-17-a", package.fetch("dependencies").fetch("@ruby/3.4-wasm-wasi")
    assert_equal "2.9.4-2026-07-17-a", package.fetch("dependencies").fetch("@ruby/wasm-wasi")
